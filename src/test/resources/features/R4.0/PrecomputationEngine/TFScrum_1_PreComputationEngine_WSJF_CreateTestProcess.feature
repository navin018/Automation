...
# 	 Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Task_wsjf_Function" and add the formula "MAX ( priority , business value )" for tool "TFS Scrum"
# 	 
# 	 
...
#	Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Epic_wsjf_Function" and add the formula "SUM ( priority , business value )" for tool "TFS Scrum"
#	
#	
...
#	Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Bug_wsjf_Function" and add the formula "MIN ( BusinessValue , Priority )" for tool "TFS Scrum"
#	
#	
...
# 	Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Impediment_wsjf_Function" and add the formula "AVG ( BusinessValue , Priority )" for tool "TFS Scrum"
# 	
# 	
...
#  	Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Feature_wsjf_Function" and add the formula "MAX ( BusinessValue , Priority )" for tool "TFS Scrum"
#  	
#  	
...
#    Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Work Request_wsjf_Function" and add the formula "SUM ( CostApproved , Priority )" for tool "TFS Scrum"
#       
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Decision_wsjf_Multiply_0" and add the formula " Priority * 0 " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Decision_wsjf_Deno_0" and add the formula " Priority / 0" for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Decision_wsjf_Nume_0" and add the formula " 0 / Priority " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Decision_wsjf_Decimal_Output" and add the formula " Priority - 6 " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Decision_wsjf_Decimal_Output" and add the formula "Priority * 0.5 " for tool "TFS Scrum"
##   
##   
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Issue_wsjf_Multiply_0" and add the formula " Priority * 0 " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Issue_wsjf_Deno_0" and add the formula " Priority / 0" for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Issue_wsjf_Nume_0" and add the formula " 0 / Priority " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Issue_wsjf_Decimal_Output" and add the formula " Priority - 6 " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "Issue_wsjf_Decimal_Output" and add the formula " Priority * 0.5 " for tool "TFS Scrum"
##   
##   
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "TestCase_wsjf_Multiply_0" and add the formula " Priority * 0 " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "TestCase_wsjf_Deno_0" and add the formula " Priority / 0" for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "TestCase_wsjf_Nume_0" and add the formula " 0 / Priority " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "TestCase_wsjf_Decimal_Output" and add the formula " Priority - 6 " for tool "TFS Scrum"
##   Then i "add" a process of type "Compute" for entity "WorkItem" and subentity "TestCase_wsjf_Decimal_Output" and add the formula " Priority * 0.5 " for tool "TFS Scrum"
