...
Scenario: TFSScrum_PrecomputationEngine_WSJF_IBVerification_UserStory
	...
	And i verify the "inbound" details for "Story_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality  
...
#	And i verify the "inbound" details for "Epic_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality  	
#	
...
#	And i verify the "inbound" details for "Feature_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality
#	
...
#	And i verify the "inbound" details for "Deliverable_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality
#	
#	
...
#	And i verify the "inbound" details for "Impediment_wsjf_Negative_Int" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality 
#	And i verify the "inbound" details for "Impediment_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality 
#	
...
#	And i verify the "inbound" details for "Task_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality  
#	
...
#	And i verify the "inbound" details for "Bug_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality 
#	
...
#	And i verify the "inbound" details for "Work Request_wsjf_Function" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality 

Scenario: TFSScrum_PrecomputationEngine_WSJF_IBVerification_StoryAssociatedToTask	
	And i verify the "inbound" details for "Story_wsjf_AssocationToTask" for tool "TFS Scrum" using "flat" query whose client is "PreComputationEngine_ClientUId" and DC is "PreComputationEngine_DeliveryConstructUId_L2" for "WSJF" functionality	
