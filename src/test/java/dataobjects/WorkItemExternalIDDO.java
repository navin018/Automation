...
public class WorkItemExternalIDDO {
	
	public static WorkItemExternalIDDO INSTANCE;
	...
	public Map<String, WorkItemExternalIDDO> item;
	
	public static void setInstance(WorkItemExternalIDDO instance){
		INSTANCE = instance;
	}
	
	public static WorkItemExternalIDDO getINSTANCE() {
		return INSTANCE;
	}
