...
//				clickJS(prepareWebElementWithDynamicXpath2(MyWizardUIMap.SelectProgram_statictxt,DC,Program,"dcname","programname"));
	...
	public static void SelectClientAndDCForRMP_og(){
		try{
...
//				clickJS(prepareWebElementWithDynamicXpath2(MyWizardUIMap.SelectProgram_statictxt,DC,Program,"dcname","programname"));
	...
	case "Precomputation Engine":
			
			try{
			ExpWaitForCondition(MyWizardUIMap.ComputationProcess_icon);
			Thread.sleep(2000);
			ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
				}
			catch(Exception e)
...
//				 driver().switchTo().window(tabs2.get(2));
	...
	public static void SelectClientAndDCForNoToolInstance() {
try{
			...
			ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 clickJS(MyWizardUIMap.scopeSelector_drpdown);
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 enterText(MyWizardUIMap.ScopeSelectorEnterTxt_txtbox,Property.getProperty("NoToolInstance_Client"));
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 Thread.sleep(2000);
			 if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectClient_statictxt,Property.getProperty("NoToolInstance_Client"),"clientname")))
			 { 
				 clickJS(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectClient_statictxt,Property.getProperty("NoToolInstance_Client"),"clientname"));
				 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
//				 clear(MyWizardUIMap.ScopeSelectorEnterTxt_txtbox);
			 }
			 else
			 Assert.fail("Mentioned client "+Property.getProperty("NoToolInstance_Client")+"doesnt exists");
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			waitPageToLoad();
//			if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectDC_statictxt,DC,"dcname")))
			if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectDC_statictxt,Property.getProperty("NoToolInstance_DC_L1"),"dcname")))
			{
				clickJS(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectDC_statictxt,Property.getProperty("NoToolInstance_DC_L1"),"dcname"));
				ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			}
			else
				 Assert.fail("Mentioned client "+Property.getProperty("NoToolInstance_DC_L1")+"doesnt exists");
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 if(!Property.getProperty("NoToolInstance_DC_L2").equalsIgnoreCase("NA"))
			 {
				 if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectProgram_statictxt,Property.getProperty("NoToolInstance_DC_L2"),"programname")))
				 clickJS(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectProgram_statictxt,Property.getProperty("NoToolInstance_DC_L2"),"programname"));
//				clickJS(prepareWebElementWithDynamicXpath2(MyWizardUIMap.SelectProgram_statictxt,DC,Program,"dcname","programname"));
				 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 }
	...
	public static void SelectClientAndDCForSpecificFunctionality(String client, String dC_L1, String dC_L2) {
		try{
			ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			boolean clientalreadyselected=false;
			boolean DC_L1_Selected=false;
			...
			{
				clientalreadyselected=true;
				if(getAttribute(MyWizardUIMap.scopeSelector_drpdown, "title").contains(Property.getProperty(dC_L1)))
					DC_L1_Selected=true;
			...
			ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 clickJS(MyWizardUIMap.scopeSelector_drpdown);
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 enterText(MyWizardUIMap.ScopeSelectorEnterTxt_txtbox,Property.getProperty(client));
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 Thread.sleep(2000);
			 if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectClient_statictxt,Property.getProperty(client),"clientname")))
			 { 
				 if(!clientalreadyselected)
				 clickJS(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectClient_statictxt,Property.getProperty(client),"clientname"));
				 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
//				 clear(MyWizardUIMap.ScopeSelectorEnterTxt_txtbox);
			 }
			 else
			 Assert.fail("Mentioned client "+Property.getProperty(client)+"doesnt exists");
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			waitPageToLoad();
//			if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectDC_statictxt,DC,"dcname")))
			if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectDC_statictxt,Property.getProperty(dC_L1),"dcname")))
			{
				if(!DC_L2_Selected)
				clickJS(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectDC_statictxt,Property.getProperty(dC_L1),"dcname"));
				ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			}
			else
				 Assert.fail("Mentioned client "+Property.getProperty(dC_L1)+"doesnt exists");
			 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 if(!Property.getProperty(dC_L2).equalsIgnoreCase("NA"))
			 {
				 if(isVisible(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectProgram_statictxt,Property.getProperty(dC_L2),"programname")))
					 if(!DC_L2_Selected)
				 clickJS(prepareWebElementWithDynamicXpath(MyWizardUIMap.SelectProgram_statictxt,Property.getProperty(dC_L2),"programname"));
//				clickJS(prepareWebElementWithDynamicXpath2(MyWizardUIMap.SelectProgram_statictxt,DC,Program,"dcname","programname"));
				 ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			 }
