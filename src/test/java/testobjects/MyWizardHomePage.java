...
break;
	...
	public static void SelectClientAndDCForNoToolInstance() {
		try{
			...
			boolean DC_L1_Selected=false;
			boolean DC_L2_Selected=false;
				if(getAttribute(MyWizardUIMap.scopeSelector_drpdown, "title").contains(Property.getProperty("NoToolInstance_Client")))
				{
				clientalreadyselected=true;
				if(getAttribute(MyWizardUIMap.scopeSelector_drpdown, "title").contains(Property.getProperty("NoToolInstance_DC_L1")))
				DC_L1_Selected=true;
				if(getAttribute(MyWizardUIMap.scopeSelector_drpdown, "title").contains(Property.getProperty("NoToolInstance_DC_L2")))
				DC_L2_Selected=true;
				}
			...
			if(!Property.getProperty("MyWizard_DC_L2").equalsIgnoreCase("NA"))
			{
			enterText(MyWizardUIMap.ScopeSelectorEnterTxt_txtbox,Property.getProperty("NoToolInstance_DC_L2"));
			ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			Thread.sleep(2000);
			...
			{
			enterText(MyWizardUIMap.ScopeSelectorEnterTxt_txtbox,Property.getProperty("NoToolInstance_DC_L1"));
			ExpWaitForElementToDisappear(MyWizardUIMap.waitSign_Img);
			Thread.sleep(2000);
