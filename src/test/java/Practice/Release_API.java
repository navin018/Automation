...
//			 requestParams.put("WorkItemExternalId", "BOM-3296");
			...
			String url = "https://mywizardapi-devtest-lx.aiam-dh.com/core/v1/Iterations/Query/flat?clientUId=00100000-0000-0000-0000-000000000000&deliveryConstructUId=9b733b7c-2591-4116-b9fd-85b500400643&includeCompleteHierarchy=false";
...
//			 System.out.println(response.getBody().asString());
			 List<String> jsonResponse = response.jsonPath().getList("Iterations");
//			 int size = response.jsonPath().getList("Iterations.size()");
			 ...
			 for(int p=0; p<size;p++)
			 {
				 ...
				 if(name.equalsIgnoreCase("Release_AutomationData_Donot_Edit4290"))
				 
				 {
					 System.out.println(response.jsonPath().getString("Iterations[" + p + "].StartOn"));
				 }
